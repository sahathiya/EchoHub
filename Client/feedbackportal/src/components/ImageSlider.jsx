  ...
  return (
    <section className="flex flex-col-reverse md:flex-row items-center justify-between px-6 md:px-20 py-12 bg-gray-100 min-h-screen">
      ...
      <div className="text-center md:text-left md:w-1/2">
        <h1 className="text-3xl md:text-5xl font-bold text-gray-800 mb-6">
        EchoHub: <br />
          <span className="text-green-600">Listen better. Grow faster.</span>
        </h1>
        <p className="text-gray-600 mb-8">
      ...
      className="group flex items-center space-x-2 bg-green-600 text-white px-6 py-3 rounded-md
                 hover:bg-green-500 focus:outline-none focus:ring-2 focus:ring-green-300 focus:ring-offset-2
                 transition"
    >
